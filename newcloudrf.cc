...
int main(int argc, char *argv[]){
    ...
    double wide_area = 0.0, height_area = 0.0, degrees_numeric = 0.0;
    char *tx_char_input;
    // defrees minutes seconds
    double tx_degrees = 55.895436;
    ...
    receptors[0] = {55.895017, -3.255537, height_Mobile};

    receptors[1] = {55.894908, -3.254606, height_Mobile}; //bot right area point

    receptors[2] = {55.895017, -3.255537, height_Mobile}; // top left area point 

    /* AREA
    *  min-right: 55.894908, -3.254606
    ...
    * Wide and height area */
    ...
    height_area = Distance(receptors[2], receptors[3]); //km
    wide_area = Distance(receptors[2], receptors[4]); //km
